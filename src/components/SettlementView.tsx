          ...
          setTimeout(() => {
            ...
            if (result === "WIN") {
              confetti({
                ...
                spread: 80,
                origin: { y: 0.5 },
                colors: ["#2563eb", "#3b82f6", "#60a5fa", "#22c55e", "#fbbf24"],
              });
            }
          }, 500);
          return 0;
          ...
          >
            <motion.div
              ...
              className={`text-6xl font-mono font-bold mb-2 ${
                countdown <= 3 ? "text-down" : "text-text"
              }`}
            >
            ...
            <div className="mt-4 h-1.5 rounded-full bg-bg overflow-hidden">
              <motion.div
                ...
                initial={{ width: "0%" }}
                animate={{ width: `${100 - (countdown / 10) * 100}%` }}
        ...
        >
          ...
          >
            <motion.div
              ...
              className="w-20 h-20 rounded-full bg-up/15 flex items-center justify-center mx-auto mb-4 glow-up"
            >
            ...
            >
              ...
              <div className="text-sm text-text-dim mb-6">
                +{((currentTrade?.stake || 0) * (currentTrade?.multiplier || 1)).toFixed(1)} tUSDC
                earned
              </div>
            </motion.div>
        ...
        >
          ...
          >
            <motion.div
              ...
              className="w-20 h-20 rounded-full bg-down/15 flex items-center justify-center mx-auto mb-4 glow-down"
            >
